...
const FoodGalary = () => {
    ...
    const recipes = [
        ...
        },
        {
            ...
            "description": "Pulled out favorite fresh veggies, drizzled with sesame oil, rice vinegar and a kiss coconut aminos. And reminded myself that fast food doesn&rsquo;t have to come from a drive thru.",
            "price": 12.99,
            "category": "Healthy Quick Meals",
            "like": [],
            "dislike": [],
        ...
        },
        {
            ...
            "description": "My studio was filled with so many sweets. So we piled them in a pan and sent them off to a holiday party for at-risk youth. SO glad they didn&rsquo;t have to get dumped!",
            "price": 12.99,
            "category": "Cake",
            "like": [],
            "dislike": [],
        ...
        },
        {
            ...
            "description": "So we piled them in a pan and sent them off to a holiday party for at-risk youth. SO glad they didn&rsquo;t have to get dumped, my studio was filled with so many sweets.",
            "price": 12.99,
            "category": "Cake",
            "like": [],
            "dislike": [],
        ...
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-20">
                    ...
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table. Franzen you probably haven&rsquo;t heard of them man bun deep jianbing selfies heirloom.</p>
                </div>
